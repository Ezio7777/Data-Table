...
document.addEventListener("DOMContentLoaded", function () {
  function displayData() {
    ...
    for (var i = 0; i < displayData.length; i++) {
      ...
      nameParagraph.className = "name-class";
      nameParagraph.innerText = item.Name;

      var numberParagraph = document.createElement("p");
      numberParagraph.className = "number-class";
      numberParagraph.innerText = item.Number;

      nameCell.appendChild(nameParagraph);
      nameCell.appendChild(numberParagraph);

      var descriptionCell = row.insertCell();
      descriptionCell.classList.add("description-class"); // Add this line to include a class
      ...
      var amount1Value = document.createElement("p");
      amount1Value.className = "amount1-class";
      amount1Value.innerText = "$" + item.Amount1;

      var amount1Currency = document.createElement("p");
      amount1Currency.className = "cad-class";
      amount1Currency.innerText = "CAD";

      amount1Wrapper.appendChild(amount1Value);
      amount1Wrapper.appendChild(amount1Currency);
      amount1Cell.appendChild(amount1Wrapper);

      var amount2Cell = row.insertCell();
      var amount2Wrapper = document.createElement("div");
      ...
      var amount2Currency = document.createElement("p");
      amount2Currency.className = "cad-class";
      amount2Currency.innerText = "CAD";
      ...
      var amount3Value = document.createElement("p");
      amount3Value.className = "amount3-class";
      amount3Value.innerText = "$" + item.Amount3;

      var amount3Currency = document.createElement("p");
      amount3Currency.className = "cad-class";
      amount3Currency.innerText = "CAD";
